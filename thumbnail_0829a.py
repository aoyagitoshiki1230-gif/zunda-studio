...
def _badge(d, xy, text, font, bg, fg=(255, 255, 255), pad=(20, 12)):
    if not text:
        return 0
...
def alert(t, base=None):
    ...
    y = 44
    y += _badge(d, (TEXT_X, y), t.get("eyebrow", ""), f(FM, 34), (250, 214, 70), (60, 20, 12)) + 20
    ...
    if t.get("sub"):
        ...
        d.text((TEXT_X, 662), t["sub"], font=f(FM, 36), fill=(255, 236, 214))
    return img
...
def guide(t, base=None):
    ...
    if t.get("sub"):
        ...
        d.text((TEXT_X, 662), t["sub"], font=f(FM, 36), fill=(206, 224, 246))
    return img
...
def number(t, base=None):
    ...
    y = 42
    y += _badge(d, (TEXT_X, y), t.get("eyebrow", ""), f(FM, 34), acc) + 16
    ...
    if t.get("sub"):
        d.rectangle([TEXT_X, 640, TEXT_X + 300, 649], fill=acc)
        d.text((TEXT_X, 662), t["sub"], font=f(FM, 36), fill=(64, 92, 56))
    return img
