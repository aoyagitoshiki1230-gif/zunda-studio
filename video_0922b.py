...
ART_WORDS = {
    "年金": ("nenkin",), "税": ("zei", "kokuzei", "genzei"), "確定申告": ("kakuteishinkoku",),
    "詐欺": ("sagi", "akutoku", "ayashii", "damasu"), "泥棒": ("dorobou",),
    "電話": ("denwa",), "訪問": ("houmon",), "相続": ("isan", "souzoku"),
    "遺言": ("yuigon",), "お墓": ("ohaka",), "葬儀": ("osoushiki",),
    "介護": ("kaigo", "kurumaisu"), "病院": ("byouin", "medical", "nyuuin"),
    "薬": ("kusuri",), "保険": ("hoken",), "銀行": ("ginkou", "atm", "tsuchou"),
    "株": ("kabu",), "投資": ("toushi",), "家計": ("kakei", "kakeibo"),
    "値上げ": ("neage", "seikyusyo"), "買い物": ("shopping", "kaimono"),
    "役所": ("shiyakusho", "yakusho", "madoguchi", "building_gyousei"),
    "書類": ("shorui", "syorui", "document", "fuutou"),
    "困る": ("komaru", "atama_kakaeru", "shinpai"), "驚く": ("bikkuri", "odoroku"),
    "喜ぶ": ("happy", "yorokobu", "egao"), "怒る": ("angry", "okoru"),
    "高齢者": ("obaasan", "ojiisan", "koureisha"), "若者": ("gakusei", "student", "boy", "girl"),
}
